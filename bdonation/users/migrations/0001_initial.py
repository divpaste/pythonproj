    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bgroup', models.CharField(blank=True, choices=[('A+', 'A+'), ('A-', 'A-'), ('B+', 'B+'), ('B-', 'B-'), ('AB+', 'AB+'), ('AB-', 'AB-'), ('O+', 'O+'), ('O-', 'O-')], max_length=3, null=True)),
                ...
                ('role', models.CharField(choices=[('R', 'Reciever'), ('D', 'Donor')], default='R', max_length=1)),
